...
// 	CloseMessage
// )
// TODO: maybe make this configurable? If the user wants to use their own message types?

const (
	TextMessage   MessageType = MessageType(websocket.TextMessage)
	BinaryMessage MessageType = MessageType(websocket.BinaryMessage)
	CloseMessage  MessageType = MessageType(websocket.CloseMessage)
	PingMessage   MessageType = MessageType(websocket.PingMessage)
	PongMessage   MessageType = MessageType(websocket.PongMessage)
)
