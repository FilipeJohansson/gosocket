...
func newMaxDepthExceededError(val int) error {
	return fmt.Errorf("%w: %s", ErrMaxDepthExceeded, val)
}

func newMaxKeyLengthExceededError(val int) error {
	return fmt.Errorf("%w: %s", ErrMaxKeyLengthExceeded, val)
}

func newMaxElementsExceededError(val int) error {
	return fmt.Errorf("%w: %s", ErrMaxElementsExceeded, val)
}

func newMaxStringLengthExceededError(val int) error {
	return fmt.Errorf("%w: %s", ErrMaxStringLengthExceeded, val)
}
...
func newDataTooLongError(val int) error {
	return fmt.Errorf("%w: %s", ErrDataTooLong, val)
}
